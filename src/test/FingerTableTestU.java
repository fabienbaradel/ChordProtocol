...
public class FingerTableTestU {
	...
	/**
	 * Teste le calcul de la distance entre un chordnode et la lowerband d'une de
	 * ses lignes
	 */
	@Test
	...
	/**
	 * Teste le calcul de la distance entre un chordnode et la lowerband d'une de
	 * ses lignes avec un intervalle comprenant 0
	 */
	@Test
	...
	/**
	 * Teste la méthode closerThanRef avec des intervalles simples
	 */
	@Test
	...
	/**
	 * Teste la méthode closerThanRef avec des intervalles comprenants 0
	 */
	@Test
	...
	/**
	 * Teste si le successor d'une fingertable juste apres son initialisation est
	 * le chornode lui même
	 * 
	 */
	@Test
	...
	/**
	 * Ajout d'un chordNode dans une fingertable simple
	 */
	@Test
	...
	/**
	 * Ajout de 2 chordNodes dans une fingertable simple
	 */
	@Test
	...
	/**
	 * Ajout de 3 chordNodes dans une fingertable simple
	 */
	@Test
	...
	/**
	 * Ajout de 3 chordNodes dans une fingertable simple
	 * et un ajout de chordnode déja ajouté
	 */
	@Test
	...
	/**
	 * Ajout de 4 chordNodes dans une fingertable simple
	 */
	@Test
	...
	/**
	 * Ajout de 6 chordNodes dans une fingertable simple
	 */
	@Test
	...
	/**
	 * Ajout de 6 chordNodes avec un autre ordre d'ajout dans une fingertable simple
	 */
	@Test
	...
	/**
	 * Ajout de 6 chordNodes d'ajout dans une fingertable complexe
	 */
	@Test
	...
	/**
	 * Nombreux ajouts dans une fingertable complexes
	 */
	@Test
	...
	/**
	 * Remove de tous les neouds ajoutés dans un FT simple
	 */
	@Test
	...
	/**
	 * Un remove dans un FT simple avec beaucoup de noeuds
	 */
	@Test
	...
	/**
	 * Nombreux remove dans une FT complexe
	 */
	@Test
	...
	/**
	 * Remove d'un noeud inconnu dans une FTsimple
	 */
	@Test
	...
	@Test
	public void testGetPredecessor1() {
		ChordNode c0 = new ChordNode(0);
		FingerTable ft = new FingerTable(c0);
		assertNull(ft.getPredecessor());
	}
	...
	@Test
	public void testGetPredecessor2() {
		ChordNode c0 = new ChordNode(0);
		FingerTable ft = new FingerTable(c0);
		assertNull(ft.getPredecessor());
	...
	@Test
	public void testGetPredecessor3() {
		ChordNode c0 = new ChordNode(0);
		FingerTable ft = new FingerTable(c0);
		assertNull(ft.getPredecessor());
	...
	@Test
	public void testGetPredecessor4() {
		ChordNode c35 = new ChordNode(35);
